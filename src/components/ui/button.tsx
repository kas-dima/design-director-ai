  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        // JSPACE Premium Variants
        hero: "bg-primary text-primary-foreground hover:bg-primary/95 shadow-soft hover:shadow-card hover:-translate-y-0.5",
        "hero-outline": "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground",
        minimal: "bg-transparent text-foreground hover:bg-secondary border-b-2 border-transparent hover:border-primary rounded-none px-0",
